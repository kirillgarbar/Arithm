...
[<assembly: AssemblyTitleAttribute("Arithm.Tests")>]
[<assembly: AssemblyProductAttribute("Arithm")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Arithm.Tests"
    let [<Literal>] AssemblyProduct = "Arithm"
